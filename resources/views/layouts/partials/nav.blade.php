...
<header class="bg-red-200 text-gray-600">
    ...
    <div class="container flex flex-col md:flex-row justify-between mx-auto p-5 items-center">
      <a href="{{ route('front')}}" class="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
      ...
      <nav class="flex flex-col md:flex-col lg:flex-row lg:ml-7 items-center text-base text-indigo-400 justify-center gap-1">
        <a class="mr-5 hover:text-white">Inicio</a>
        <a class="mr-5 hover:text-white">Fragancias</a>
        <a class="mr-5 hover:text-white">Quienes somos</a>
        <a class="mr-5 hover:text-white">Contactanos</a>
      </nav>
