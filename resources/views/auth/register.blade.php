...
@section('content')
    ...
    <div class="container mx-auto max-w-screem-md">
        <div class="flex flex-wrap justify-center">
                        ...
                        <form class="py-10 px-5" method="POST" action="{{ route('register') }}" novalidate>
                            ...
                            <div class="flex flex-wrap mb-6">
                                ...
                                <input id="name" type="text"
                                    class="p-3 bg-gray-300 rounded form-input w-full @error('name') is-invalid @enderror"
                            ...
                            <div class="flex flex-wrap mb-6">
                                ...
                                <input id="password-confirm" type="password"
                                    class="p-3 bg-gray-300 rounded form-input w-full" name="password_confirmation" 
                                    autocomplete="new-password">
                            </div>

                            <div class="flex flex-wrap">
                                <button type="submit" class="bg-blue-500 w-full hover:bg-blue-700
                                        text-gray-900 p-3 focus:outline-none 
            ...
            <div class="md:w-1/2 order-1 md:order-2 text-center flex flex-col justify-center px-10 mt-10">
                <h1 class="text-blue-500 text-3xl">Bienvenido registrate</h1>
                <p class="text-xl mt-5 leading-7">Crea una cuenta gratis y publica muchos producto</p>
            </div>
