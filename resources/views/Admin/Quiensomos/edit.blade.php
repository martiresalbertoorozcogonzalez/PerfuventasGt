...
<form class="flex flex-col max-w-lg mx-auto p-0 m-0 my-10"  action="{{ route('quiensomos.update', ['quiensomos'=> $quiensomos->id]) }}" method="POST" enctype="multipart/form-data" novalidate>
    
@csrf
@method('PUT')

<h1 class="text-5xl text-center font-bold px-10 py-10">Editar Quien somos</h1>
...
<div class="mb-5">
    ...
    <input type="hidden" name="descripcion" id="descripcion" value="{{ $quiensomos->descripcion }}">
...
<div class="form-group mt-3">
    <label for="imagen">Elige una imagen para quien somos</label>
    <input type="file" name="imagen" id="imagen"
        class="form-control @error('imagen') is-invalid @enderror ">

        <div class="mt-4">
            <p>Imagen Actual</p>
            <img class="mt-3 mb-3" src="/storage/{{$quiensomos->imagen}}" style="width:200px;">
        </div>
...
<button class="bg-teal-500 w-full hover:bg-purple-500	bg-purple-400 font-bold p-3 focus:outline focus:shadow-outline uppercase ">Editar Quien somos</button>
